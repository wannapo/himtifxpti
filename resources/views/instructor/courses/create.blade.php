            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('instructor.courses.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" id="description" rows="5" class="w-full border-gray-300 rounded-md" required>{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="status" id="status" class="w-full border-gray-300 rounded-md" required>
                            ...
                            <option value="published" {{ old('status') === 'published' ? 'selected' : '' }}>Published (Tampilkan secara publik)</option>
                        </select>
                    </div>

                    <div class="mb-6">
                        <label for="image" class="block text-gray-700 font-bold mb-2">Gambar Sampul (Opsional)</label>
                    ...
                    <div class="flex justify-end gap-4">
                        ...
                        <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded font-bold hover:bg-blue-700">Simpan Kursus</button>
                    </div>
                </form>
            </div>
        </div>
